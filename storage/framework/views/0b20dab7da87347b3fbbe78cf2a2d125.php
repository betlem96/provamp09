...
<head>
    ...
    <title><?php echo e($title ?? 'Laravel for PHP developers'); ?></title>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/users"
                                   class="text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Users</a>                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
...
<?php /**PATH /home/alumne/Escriptori/M9/example-app/resources/views/components/layout.blade.php ENDPATH**/ ?>